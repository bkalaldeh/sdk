...
"use strict";function CreditsAPI(e){if(this.context=e,!this.context)throw Error("invalid creditsSystem context")}CreditsAPI.prototype={_sendRequest:function(e,t,n,s){var i="",r=void 0,c=void 0;n.public_key&&(r=n.public_key),n.secret_key&&(c=n.secret_key),delete n.public_key,delete n.secret_key;var a=new XMLHttpRequest,o=window.siteConfig.endPoints.creditSystemHost+"/credit_system/"+t;if("GET"===(e=e.toUpperCase())&&n){var u="?";for(var d in n)n.hasOwnProperty(d)&&(u+=d+"="+encodeURIComponent(n[d])+"&");o+=u=u.slice(0,-1)}else i=JSON.stringify(n);a.open(e,o,!0),a.setRequestHeader("Content-Type","application/json"),r&&a.setRequestHeader("public_key",r),c&&a.setRequestHeader("secret_key",c),a.setRequestHeader("x-api-key","ZBtYjI3ZlNaKdhWApTjIF3NYaynO4snJ1zikGTDr"),a.onreadystatechange=function(){var e=null;try{e=JSON.parse(a.responseText)}catch(e){}4==a.readyState&&(200===a.status?s&&s(null,e):s&&s(e))},a.send(i)},updateMerchant:function(s,i){var r=this;appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,json_config:s.jsonConfig};window.authAPI.getCurrentUser(function(e,t){n.user_token=t&&t._id?t._id.toString():null,n.user_token?r._sendRequest("PUT","merchants",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})})},purchaseBundle:function(r,c){var a=this;function s(e){var s=e.sessionId,i=e.transactionId;i?s?appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,payment_provider:r.paymentProvider,transaction_id:i,stripe:{session_id:s},bundle_id:r.bundleId,access_token:r.access_token};window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?a._sendRequest("POST","credits/purchase",n,function(e,t){c&&c(e,t)}):c&&c({message:"no logged in user"})})}):c&&c("Missing sessionId parameter in purchase",null):c&&c("Missing transactionId parameter in purchase",null)}r?r.bundleId?window.authAPI.getCurrentUser(function(e,t){r.access_token=t&&t.accessToken?t.accessToken.toString():null,r.access_token?(r.paymentProvider="stripe",appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,payment_provider:r.paymentProvider,bundle_id:r.bundleId,memo:r.memo,x_ref_1:r.xRef1,x_ref_2:r.xRef2,x_ref_3:r.xRef3,access_token:r.access_token};a._sendRequest("POST","credits/transactions",n,function(e,n){e?c(e):n&&n.transactionId&&n.stripe&&n.stripe.clientReferenceId?new StripeAPI(a.context).purchase({items:[{sku:n.stripe.skuId}],clientReferenceId:n.stripe.clientReferenceId},function(e,t){e||s({transactionId:n.transactionId,sessionId:t.id})}):c({message:"missing stripe data in transaction"})})})):c&&c({message:"no logged in user"})}):c&&c("Missing bundleId parameter",null):c&&c("invalid params",null)},getMerchant:function(e,s){var i=this;appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,secret_key:t.creditsSystemSecretKey};i._sendRequest("GET","merchants",n,function(e,t){s&&s(e,t)})})},getBundles:function(e,s){var i=this;appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,secret_key:t.creditsSystemSecretKey};i._sendRequest("GET","bundles",n,function(e,t){s&&s(e,t)})})},deleteBundle:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,bundle_id:s.bundleId};window.authAPI.getCurrentUser(function(e,t){n.user_token=t&&t._id?t._id.toString():null,n.user_token?r._sendRequest("DELETE","bundles",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid params",null)},insertBundle:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,name:s.name,stripe_product_id:s.stripeProductId,description:s.description,credit_amount:s.creditAmount,user_token:s.userToken,image_url:s.imageUrl};window.authAPI.getCurrentUser(function(e,t){n.user_token=t&&t._id?t._id.toString():null,n.user_token?r._sendRequest("POST","bundles",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid params",null)},updateBundle:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,name:s.name,stripe_product_id:s.stripeProductId,description:s.description,credit_amount:s.creditAmount,bundle_id:s.bundleId,user_token:s.userToken,image_url:s.imageUrl};window.authAPI.getCurrentUser(function(e,t){n.user_token=t&&t._id?t._id.toString():null,n.user_token?r._sendRequest("PUT","bundles",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid params",null)},adjustCredits:function(s,i){var r=this;s?s.userToken?s.creditAmount?appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,user_token:s.userToken,credit_amount:s.creditAmount,memo:s.memo,x_ref_1:s.xRef1,x_ref_2:s.xRef2,x_ref_3:s.xRef3};window.authAPI.getCurrentUser(function(e,t){n.created_by_user_token=t&&t._id?t._id.toString():null,n.created_by_user_token?r._sendRequest("POST","credits/adjust",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid creditAmount",null):i&&i("invalid userToken",null):i&&i("invalid params",null)},consumeCredits:function(s,i){var r=this;s?s.creditAmount?appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,credit_amount:s.creditAmount,x_ref_1:s.xRef1,x_ref_2:s.xRef2,x_ref_3:s.xRef3,memo:s.memo};window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?r._sendRequest("POST","credits/consume",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("Missing creditAmount parameter",null):i&&i("invalid params",null)},transferCredits:function(s,i){var r=this;s?s.creditAmount?s.receiverUserToken?appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,credit_amount:s.creditAmount,receiver_user_token:s.receiverUserToken,x_ref_1:s.xRef1,x_ref_2:s.xRef2,x_ref_3:s.xRef3};window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?r._sendRequest("POST","credits/transfer",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("Missing receiverUserToken parameter",null):i&&i("Missing creditAmount parameter",null):i&&i("invalid params",null)},searchTransactions:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey,secret_key:t.creditsSystemSecretKey,users_tokens:s.usersTokens,page_size:s.pageSize,page_index:s.pageIndex,from_date:s.fromDate,to_date:s.toDate,x_ref_1:s.xRef1,x_ref_2:s.xRef2,x_ref_3:s.xRef3};window.authAPI.getCurrentUser(function(e,t){!n.public_key||(n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token)?r._sendRequest("POST","credits/transactions/search",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid params",null)},getUser:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={public_key:t.creditsSystemPublicKey};s.secretKey&&(n.secret_key=s.secretKey),window.authAPI.getCurrentUser(function(e,t){n.access_token=t&&t.accessToken?t.accessToken.toString():null,n.access_token?r._sendRequest("GET","credits/user",n,function(e,t){i&&i(e,t)}):i&&i({message:"no logged in user"})})}):i&&i("invalid params",null)},searchUsers:function(s,i){var r=this;s?appApiKeys.get(function(e,t){var n={secret_key:t.creditsSystemSecretKey,users_tokens:s.usersTokens,page_size:s.pageSize,page_index:s.pageIndex};r._sendRequest("POST","credits/users",n,function(e,t){i&&i(e,t)})}):i&&i("invalid params",null)},getTransactionsLogs:function(s,i){var r=this;s?appApiKeys.get(function(e,t){if(s.creditTransactionId){var n={secret_key:t.creditsSystemSecretKey};r._sendRequest("GET","credits/transaction/"+s.creditTransactionId+"/logs",n,function(e,t){i&&i(e,t)})}else i&&i("Missing creditTransactionId parameter",null)}):i&&i("invalid params",null)}};
